...
tools. Measured against `chromium/src` at the locked commit `ae03f7fb2c`:
`update.googleapis.com` is referenced by 2 files, `gstatic.com/generate_204` by 4,
`optimizationguide-pa.googleapis.com` by 1 — and none of the three appears in the
